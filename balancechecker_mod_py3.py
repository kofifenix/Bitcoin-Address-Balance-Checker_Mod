...
def process_addresses(input_file, output_file):
    ...
    for addr in addresses:
        ...
        print(f'Address: {addr}, Balance: {addr_balance}')
...
def main():
    input_file = input("Enter the path to the input file with Bitcoin addresses: ")
    output_file = input("Enter the path to the output file for valid addresses: ")
